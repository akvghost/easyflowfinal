...
export class CompanySendRequest extends Component {
  constructor(props) {
    super(props);
    this.state = {
      show: false,
   ...
   handleChange = (e) => {
    ...
    this.setState({ vacany: e.target.value})
      ...
      <div className="container">
        <form className="row g-3" onSubmit={this.handleSubmit}>
          <div className="col-md-6">
            ...
            <input type="text" name={"name"} onChange={this.handleChange} className="form-control" id="inputEmail4" />
          </div>
          <div className="col-md-6">
            <label htmlFor="inputEmail4" className="form-label">
              Vacany
            </label>
            <input type="email" name={"vacany"} onChange={this.handleChange} className="form-control" id="inputPassword4" />
          </div>
          <div className="col-md-6">
            <label htmlFor="inputEmail4" className="form-label">
              Email
